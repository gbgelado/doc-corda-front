...
object CashOutEntity {

    @InitiatingFlow
    @StartableByRPC
    class CashOutEntityFlow(
        val document: String,
        val amount: Double
        ...
        override fun call(): SignedTransaction {
            ...
            var entityStateRef = entityList.single()

            var newAmount = entityStateRef.state.data.entity.amount - amount

            // criando um modelo de pessoa
            val entity = EntityModel(ourIdentity, Instant.now(), entityStateRef.state.data.entity.name, document, newAmount)
            ...
            val txCommand = Command(
                EntityContract.Commands.CashIn(),
    ...
    * */
    @InitiatedBy(CashOutEntityFlow::class)
